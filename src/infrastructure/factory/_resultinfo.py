...
class ResultInfoFactoryImpl(ResultInfoFactory):
    ...
    def each_jyoinfo(self,
                     target_date: date,
                     jyo_cd: int,
                     ed_race_no: int) -> Iterator[ResultInfo]:
    ...
    def _commoninfo(self,
                    lx_content: lxml.HtmlElement) -> ResultCommonInfo:
        """
        ...
        content_dict["weather_info"] = \
            self.__common_methods.getweatherinfo(
    ...
    def _playerinfo(self,
                    lx_content: lxml.HtmlElement) -> Iterator[ResultPlayerInfo]:
        target_table_xpath = \
