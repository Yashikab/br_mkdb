...
from infrastructure.const import (
    CL_FIELD_STYLES,
    CL_LEVEL_STYLES,
    DATE_FMT,
    FMT,
...
if __name__ == "__main__":
    ...
    parser.add_argument("st_date", type=str, help="start date with y-m-d")
    parser.add_argument("ed_date", type=str, help="end date with y-m-d")
    parser.add_argument("--wait", type=float, default=0.5, help="waiting time")
    parser.add_argument(
